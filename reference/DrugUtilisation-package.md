...
Summarise patient-level drug utilisation cohorts using data mapped to
...
- Kim Lopez-Guell <kim.lopez@spc.ox.ac.uk>
...
- Xihang Chen <xihang.chen@ndorms.ox.ac.uk>
  ([ORCID](https://orcid.org/0009-0001-8112-8959))

Other contributors:

- Mike Du <mike.du@ndorms.ox.ac.uk>
  ([ORCID](https://orcid.org/0000-0002-9517-8834)) \[contributor\]

- Xintong Li <xintong.li@ndorms.ox.ac.uk>
  ([ORCID](https://orcid.org/0000-0002-6872-5804)) \[contributor\]

- Marta Alcalde-Herraiz <marta.alcaldeherraiz@ndorms.ox.ac.uk>
  ([ORCID](https://orcid.org/0009-0002-4405-1814)) \[contributor\]

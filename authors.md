...
- **Marta Alcalde-Herraiz**. Contributor.
...
Source:
[`inst/CITATION`](https://github.com/iomedhealth/DrugUtilisation/blob/main/inst/CITATION)
...
Jasmine, Seager, Sarah, Vojinovic, Dina, Mayer, Angel M,
Ramírez-Anguita, Manuel J, Machín, Leis A, Oja, Marek, Kolde, Raivo,
Bonadt, Klaus, Prieto-Alhambra, Daniel, Reich, Chistian, Català, Martí
(2024). “Calculating daily dose in the Observational Medical Outcomes
Partnership Common Data Model.” *Pharmacoepidemiology and Drug Safety*,
**33**(6), e5809.
[doi:10.1002/pds.5809](https://doi.org/10.1002/pds.5809).
